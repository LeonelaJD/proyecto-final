...
<body>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-6">
              <a href="<%=request.getContextPath()%>/pedidos/agregar" class="btn btn-success">Agregar Pedidos</a>
            </div>
        </div>
                        ...
                        <tbody>
                            <% for(Pedido pedido: pedidos) {%>
                                <tr>
                                    ...
                                    <td><a href="<%=request.getContextPath()%>/pedidos/detalle?id=<%=pedido.getIdPedido()%>" class="btn btn-success">Detalle</a></td>
                                    <td><a href="<%=request.getContextPath()%>/pedidos/editar?id=<%=pedido.getIdPedido()%>" class="btn btn-primary">Editar</a></td>
                                    <td><a href="<%=request.getContextPath()%>/pedidos/eliminar?id=<%=pedido.getIdPedido()%>" class="btn btn-danger">Eliminar</a></td>
                                </tr>
                            <% } %>
                        </tbody>
                    </table>
