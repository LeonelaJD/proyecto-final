...
<body>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-6">
              <a href="<%=request.getContextPath()%>/proveedores/agregar" class="btn btn-success">Agregar Proveedor</a>
            </div>
        </div>
                        ...
                        <tbody>
                            <% for(Proveedor proveedor: proveedores) {%>
                                <tr>
                                    ...
                                    <td><a href="<%=request.getContextPath()%>/proveedores/detalle?id=<%=proveedor.getIdProveedor()%>" class="btn btn-success">Detalle</a></td>
                                    <td><a href="<%=request.getContextPath()%>/proveedores/editar?id=<%=proveedor.getIdProveedor()%>" class="btn btn-primary">Editar</a></td>
                                </tr>
                            <% } %>
                        </tbody>
                    </table>
