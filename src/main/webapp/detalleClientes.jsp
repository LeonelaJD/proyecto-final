            ...
            <div class="col-12">
                <div class="card border">
                    <div class="card header">
                        <h3><Strong>Detalle de Clientes</Strong></h3>
                    </div>
                </div>

                <div class="card border">
                    <ul class="list-group">
                        <li class="list-ground-item"><strong>Id Cliente: </strong><%=cliente.getIdCliente()%> </li>
                        <li class="list-ground-item"><strong>Nombre: </strong><%=cliente.getNombre()%> </li>
                        <li class="list-ground-item"><strong>Rfc: </strong><%=cliente.getRfc()%></li>
                        <li class="list-ground-item"><strong>Telefono: </strong><%=cliente.getTelefono()%></li>
                        <li class="list-ground-item"><strong>Direccion: </strong><%=cliente.getDireccion()%></li>
                        <li class="list-ground-item"><strong>Razon Social: </strong><%=cliente.getRazonSocial()%></li>
                        <li class="list-ground-item"><strong>Email: </strong><%=cliente.getEmail()%></li>
                    </ul>
                </div>
            </div>
        </div>
