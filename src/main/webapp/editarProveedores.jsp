...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h2>Formulario Editar Proveedor</h2>
            </div>
        </div>
        <br>
        ...
        <div class="row">
            <form action="<%=request.getContextPath()%>/proveedores/editar" method="post">
                <div class="col-md-12">
                    <input type="hidden" name="id" id="id" value="<%=proveedor.getIdProveedor()%>">
                    <div class="form-group">
                        <label for="">Nombre</label>
                        <input type="text" name="nombre" id="nombre"
                        class="form-control" value="<%=proveedor.getNombre() != null? proveedor.getNombre(): ""%>">
                        <%
                    ...
                    <div class="form-group">
                        ...
                        class="form-control" value="<%=proveedor.getRfc() != null? proveedor.getRfc(): ""%>">
                        <%
                    ...
                    <div class="form-group">
                        ...
                        class="form-control" value="<%=proveedor.getDescripcion() != null? proveedor.getDescripcion(): ""%>">
                        <%
                    ...
                    <div class="form-group">
                        ...
                        class="form-control" value="<%=proveedor.getRazonSocial() != null? proveedor.getRazonSocial(): ""%>">
                        <%
                    ...
                    <div class="form-group">
                        ...
                        class="form-control" value="<%=proveedor.getDireccion() != null? proveedor.getDireccion(): ""%>">
                        <%
                    ...
                    <div class="form-group">
                        ...
                        class="form-control" value="<%=proveedor.getEmail() != null? proveedor.getEmail(): ""%>">
                        <%
                    ...
                    <div class="form-group">
                        ...
                        class="form-control" value="<%=proveedor.getTelefono() != null? proveedor.getTelefono(): ""%>">
                        <%
