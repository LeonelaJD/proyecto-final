...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h2>Formulario Editar Clientes</h2>
            </div>
        </div>
        <br>
        ...
        <div class="row">
            <form action="<%=request.getContextPath()%>/clientes/editar" method="post">
                <div class="col-md-12">
                    <input type="hidden" name="id" id="id" value="<%=cliente.getIdCliente()%>">

                    <div class="form-group">
                        <label for="">Nombre</label>
                        <input type="text" name="nombre" id="nombre"
                        class="form-control" value="<%=cliente.getNombre() != null? cliente.getNombre(): ""%>">
                        <%
                    ...
                    <div class="form-group">
                        ...
                        class="form-control" value="<%=cliente.getRfc() != null? cliente.getRfc(): ""%>">
                        <%
                    ...
                    <div class="form-group">
                        ...
                        class="form-control" value="<%=cliente.getTelefono() != null? cliente.getTelefono(): ""%>">
                        <%
                    ...
                    <div class="form-group">
                        ...
                        class="form-control" value="<%=cliente.getDireccion() != null? cliente.getDireccion(): ""%>">
                        <%
                    ...
                    <div class="form-group">
                        ...
                        class="form-control" value="<%=cliente.getRazonSocial() != null? cliente.getRazonSocial(): ""%>">
                        <%
                    ...
                    <div class="form-group">
                        ...
                        class="form-control" value="<%=cliente.getEmail() != null? cliente.getEmail(): ""%>">
                        <%
